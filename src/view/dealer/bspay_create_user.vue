  ...
  data() {
    return {
      ...
      rules: {
        ...
        license_regions_id: { type: 'array', required: true, message: '请选择住所省市区', trigger: 'change' },
        ...
        legal_cert_begin_date: { required: true, message: '请选择身份证开始有效期', trigger: 'blur' },
        ...
        card_regions_id: { type: 'array', required: true, message: '请选择开户行所在省市', trigger: 'change' },
      ...
      indvRules: {
        ...
        card_no: [requiredRules('银行卡号'), MaxRules(40)],
        card_regions_id: { type: 'array', required: true, message: '请选择省市', trigger: 'change' },
