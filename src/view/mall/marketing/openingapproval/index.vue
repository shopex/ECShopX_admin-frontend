    ...
    <SpPage>
      <div>
        <el-card class="cus-card">
          <el-form ref="myForm" :model="params" :inline="true" label-width="80px">
            <el-row>
              <el-col :span="20">
                <el-row>
                  <el-col :span="8">
                    <el-form-item label="审批状态">
                      <el-select v-model="params.status" placeholder="请选择审批状态" class="input-m">
                        <el-option v-for="(item, index) in approveStatusList" :key="index" :label="item.name"
                          :value="item.value" />
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="商户名称">
                      <el-input v-model="params.user_name" class="input-m" placeholder="请输入" clearable />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="所属地区">
                      <el-cascader v-model="regions_value" placeholder="根据地区筛选" :options="regions" filterable clearable
                        :props="{ checkStrictly: true }" class="input-m" @change="RegionChangeSearch" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="申请日期">
                      <el-date-picker v-model="create_time" class="input-m" type="daterange" format="yyyy-MM-dd"
        ...
        <el-card>
          <div v-for="item in list" :key="item.id" class="cus-list">
            <el-row class="cus-row">
              <el-col :span="3">
                <img v-if="item.apply_type === 'distributor'" class="cus-row-img"
                  src="@/assets/img/adapay/distributor.png" alt="">
                <img v-if="item.apply_type === 'dealer'" class="cus-row-img" src="@/assets/img/adapay/dealer.png"
                  alt="">
              </el-col>
              <el-col :span="13">
              ...
              <el-col :span="5">
                <img v-if="item.status === 'APPROVED'" src="@/assets/img/adapay/pass.png" alt=""
                  style="width: 100px; height: 84px">
                <img v-if="item.status === 'REJECT'" src="@/assets/img/adapay/reject.png" alt=""
                  style="width: 90px; height: 89px">
              </el-col>
              <el-col class="cus-row-btn" :span="3" :offset="item.status === 'WAIT_APPROVE' ? 5 : 0">
                <router-link v-if="item.status === 'WAIT_APPROVE'"
          ...
          <div class="mt-4 text-right">
            <el-pagination background layout="total, sizes, prev, pager, next, jumper" :current-page.sync="params.page"
