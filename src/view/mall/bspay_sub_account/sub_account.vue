    ...
    >
      <el-card class="box-card" shadow="never">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="是否分账" prop="bspay_div_status">
        ...
        <div class="tablelist">
          ...
          <el-table v-loading="loading" :data="list" style="width: 100%">
            ...
            <template>
              ...
              <el-table-column label="支付方式">
                <template slot-scope="scope">
                  ...
                  <span v-if="scope.row.payType == 'bspay' && scope.row.payChannel == 'wx_lite'"
                  <span v-if="scope.row.payType == 'bspay' && scope.row.payChannel == 'alipay_wap'"
                    >支付宝支付</span
                  >
                </template>
              </el-table-column>
            ...
            <el-table-column label="分账类型">
              <template slot-scope="scope">
                <span v-if="scope.row.payType == 'bspay'">线上</span>
                <span v-else>线下</span>
              </template>
            </el-table-column>
            ...
            <el-table-column label="是否分账">
              <template slot-scope="scope">
                <span v-if="scope.row.bspayDivStatus == 'NOTDIV'">未分账</span>
                <span v-else-if="scope.row.bspayDivStatus == 'DIVED'">已分账</span>
              </template>
            </el-table-column>
