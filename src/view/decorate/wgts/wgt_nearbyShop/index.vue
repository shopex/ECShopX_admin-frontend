          ...
          <div v-else class="shop-content">
            <div v-for="item in shopList" :key="item.distributor_id" class="shop-item">
              ...
              <div class="store-details">
                <div class="name">
                  <span>{{ item.name }}</span>
                  <span v-if="item.is_self_delivery && item.selfDeliveryRule.is_open">商家自配送</span>
                </div>
                <div v-if="item.is_self_delivery && item.selfDeliveryRule.is_open" class="free-shipping">
                  <span
