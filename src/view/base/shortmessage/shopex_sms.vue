<template>
  <div class="shopex-sms-page">
    <div class="btn">
      <router-link v-if="!VERSION_SHUYUN" class="link" to="/setting/datamessage"> 切换短信商 </router-link>
    </div>
    <el-tabs v-model="activeName" type="border-card">
      ...
      <el-tab-pane label="短信签名" name="third">
        <div class="content-padded message-autograph">
          短信签名：
          <el-input v-model="messageAutograph" :disabled="messageAutographDis" placeholder="请输入短信签名" />
