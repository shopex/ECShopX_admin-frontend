  ...
  <SpPage>
    <div class="w-[800px] mx-auto relative">
      <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M295 89.7H100v115.799h195v-115.8Z"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path
          d="M295 83.6v6.1H100v-6.1c0-8.1 6.6-14.7 14.8-14.7h165.5c8.1-.1 14.7 6.5 14.7 14.7Z"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path d="M250.5 82a2.7 2.7 0 1 0 0-5.4 2.7 2.7 0 0 0 0 5.4Z" fill="#FFC60A" />
        <path d="M262.4 82a2.7 2.7 0 1 0 0-5.4 2.7 2.7 0 0 0 0 5.4Z" fill="#00D6B9" />
        <path d="M274.3 82a2.7 2.7 0 1 0 0-5.4 2.7 2.7 0 0 0 0 5.4Z" fill="#FFC60A" />
        <path
          d="M164.3 148.3h-8.9v15.9h-5.5v-15.9h-20.1v-3.5l19.2-27.9h6.4V144h8.9v4.3Zm-14.4-4.3v-13.3c0-2.1.3-5.6.4-7.9h-.3c-1.1 2.1-2.4 4.3-3.7 6.4L135.8 144h14.1ZM264.1 148.3h-8.9v15.9h-5.5v-15.9h-20.1v-3.5l19.2-27.9h6.4V144h8.9v4.3Zm-14.4-4.3v-13.3c0-2.1.3-5.6.4-7.9h-.3c-1.1 2.1-2.4 4.3-3.7 6.4L235.6 144h14.1Z"
          fill="#00D6B9"
          stroke="#00D6B9"
          stroke-width="1.408"
          stroke-miterlimit="10"
        />
        <path
          d="m251 173.2-29 13.7-33.9 5.9-10.2-9.7 5.2-44 39-9.9 28.9 44ZM217.5 108.9c-4.5-6.2-13.4-9.2-22.5-7-9.1 2.2-15.6 9-16.8 16.5 5.7-2.2 12.3-4.2 19.3-5.9 7.2-1.8 13.9-3 20-3.6Z"
          fill="#fff"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path
          d="M178.3 118.3c-14.4 5.5-23.6 11.9-22.5 16.4 1.5 6.4 22.8 6.7 47.5.8s43.4-15.9 41.9-22.3c-1.1-4.6-12.3-6-27.5-4.3"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path
          d="M223.4 123.8c.3-1.3-.4-2.6-1.7-2.9-4-1-12.4-.7-21.5 1.5-10.4 2.5-16.1 5.5-19.9 9.1-.8.8-.9 2.2-.2 3.1l3.1 4 38.9-9.4 1.1-4.4c0-.4.1-.7.2-1Z"
          fill="#fff"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path
          d="M203.779 138.968c10.684-2.576 18.809-6.885 18.149-9.623-.66-2.738-9.856-2.869-20.54-.293s-18.81 6.884-18.149 9.623c.66 2.738 9.856 2.869 20.54.293Z"
          fill="#0C296E"
          stroke="#0C296E"
          stroke-width=".455"
          stroke-miterlimit="10"
        />
        <path
          d="M172.065 131.343c1.449-.349 2.415-1.503 2.156-2.577-.259-1.073-1.644-1.661-3.094-1.311-1.449.35-2.415 1.503-2.156 2.577.259 1.074 1.644 1.661 3.094 1.311Z"
          fill="#FFC60A"
        />
        <path
          d="M185.742 124.039c.804-.675.793-2.01-.023-2.984-.817-.973-2.13-1.215-2.934-.54-.804.675-.794 2.01.023 2.983.816.973 2.13 1.215 2.934.541Z"
          fill="#00D6B9"
        />
        <path
          d="M199.671 120.043c1.181-.285 1.876-1.604 1.552-2.946-.323-1.342-1.543-2.199-2.724-1.914-1.182.284-1.877 1.603-1.553 2.945.324 1.343 1.543 2.2 2.725 1.915Z"
          fill="#FFC60A"
        />
        <path
          d="M214.939 117.438c1.074-.258 1.693-1.513 1.382-2.801-.311-1.289-1.433-2.124-2.507-1.865-1.073.259-1.692 1.514-1.381 2.802.31 1.289 1.433 2.123 2.506 1.864Z"
          fill="#00D6B9"
        />
        <path
          d="M229.888 117.652c1.503-.362 2.502-1.57 2.23-2.698-.272-1.127-1.711-1.747-3.214-1.385-1.504.363-2.502 1.571-2.23 2.698.272 1.127 1.711 1.748 3.214 1.385Z"
          fill="#FFC60A"
        />
        <path
          d="m191.2 170.301-.5 11.7M221 170.7l4.8 13.8M220.5 140.9l6.3 11M226.2 145.7l4.9 7.6M201.8 149.7l.7 10.5"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path
          d="M199.2 104.1s5-1.5 9.5 1.9"
          stroke="#0C296E"
          stroke-width=".939"
          stroke-miterlimit="10"
        ...
        />
        <path
          d="M210.6 108.6a.8.8 0 1 0 0-1.6.8.8 0 0 0 0 1.6ZM195 128.7a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM207.1 125.8a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"
          fill="#0C296E"
        />
        <path
          d="m199.2 127.5.2-.1c1.1-1 2.6-1.3 4-.9"
          stroke="#0C296E"
          stroke-width=".49"
          stroke-miterlimit="10"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
        <path d="M132 172.699s32.4-27.7 55.8 20.2l-55.8-20.2Z" fill="#fff" />
        <path
          d="M132 172.699s32.4-27.7 55.8 20.2"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path d="M185.8 195s20.9-23.2 50-.2l-50 .2Z" fill="#fff" />
        <path
          d="M185.8 195s20.9-23.2 50-.2"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path d="M235.7 188.399s-2.8-25.3 30-19.5l-30 19.5Z" fill="#fff" />
        <path
          d="M235.7 188.399s-2.8-25.3 30-19.5"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
        />
        <path
          d="M265.9 116.3v1.9M265.9 120.2v1.8M263 119.2h1.9M266.9 119.2h1.9"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
          stroke-linecap="round"
        ...
        />
        <path
          d="M162.7 107.6a1.4 1.4 0 1 0 0-2.8 1.4 1.4 0 0 0 0 2.8ZM260.3 181.8a1.1 1.1 0 1 0 0-2.2 1.1 1.1 0 0 0 0 2.2ZM127.5 162.1a1.3 1.3 0 1 0 0-2.6 1.3 1.3 0 0 0 0 2.6ZM133.1 120.1l-2.3-1.8 2.7-1.1-.4 2.9ZM253 98.3l-1.6 2.7h3.1l-1.5-2.7Z"
          fill="#fff"
          stroke="#0C296E"
          stroke-width=".5"
          stroke-miterlimit="10"
