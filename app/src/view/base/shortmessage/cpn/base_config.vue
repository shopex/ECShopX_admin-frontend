<template>
  <div class="alisms_baseConfig">
    ...
    <el-form label-width="200px" :model="form">
      ...
      <section class="card" v-for="item in cardData" :key="item.title">
        <div class="content">
    ...
    >
      <el-form :model="form" :rules="rules" ref="form" label-width="140px" class="form">
        <el-form-item label="AccessKey ID" prop="accesskey_id">
          <el-input v-model="form.accesskey_id" placeholder="阿里云RAM用户的 AccessKey ID">
          </el-input>
        </el-form-item>
        <el-form-item label="Accesskey Secret" prop="accesskey_secret">
