<template>
  <div class="memberReg">
        ...
        <el-card class="box-card">
          <div slot="header" class="between">
            ...
            <div>
              ...
              <el-switch v-model="isMustAuth" @change="onChangeMustAuth"></el-switch>
            </div>
          </div>
          <el-table :data="tableData" v-loading="isLoading">
            <el-table-column label="信息" prop="label"></el-table-column>
            <el-table-column label="是否启用">
              <template slot-scope="scope">
                <el-switch :value="!!scope.row.is_open" :disabled="!!scope.row.is_must_start_required" @change="toggleStatus({
                  id: scope.row.id,
            ...
            <el-table-column label="必填">
              <template slot-scope="scope">
                <el-switch :value="!!scope.row.is_required" :disabled="!!scope.row.is_must_start_required" @change="toggleStatus({
                  id: scope.row.id,
            ...
            <el-table-column label="可修改">
              <template slot-scope="scope">
                <el-switch :value="!!scope.row.is_edit" @change="toggleStatus({
                  id: scope.row.id,
            ...
            <el-table-column label="提示文案" prop='alert_required_message'></el-table-column>
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button type="text" @click="showAddDialog(scope.row)">编辑</el-button>
                <el-button v-if="!scope.row.is_default" type="text" class="delete" @click="deleteField(scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-card>
              ...
              <el-card class="box-card">
                <div class="text item">
                    <el-form-item label="注册协议标题" prop="member_register.title">
                      <el-input placeholder="注册协议标题" v-model="privacyForm.member_register.title" style="width: 500px" show-word-limit maxlength="15"></el-input>
                    </el-form-item>
                    <el-form-item label="注册协议" prop="member_register.content">
                      <vue-html5-editor :content="privacyForm.member_register.content" @change="updateContent"
              ...
              <el-card class="box-card">
                <div class="text item">
                    <el-form-item label="隐私政策标题" prop="privacy.title">
                      <el-input placeholder="隐私政策标题" v-model="privacyForm.privacy.title" style="width: 500px" show-word-limit maxlength="15"></el-input>
                    </el-form-item>
                    <el-form-item label="隐私政策" prop="privacy.content">
                      <vue-html5-editor :content="privacyForm.privacy.content" @change="updatePrivacyAgreement"
                        :height="360"></vue-html5-editor>
                    </el-form-item>
                </div>
              </el-card>
    ...
    <el-dialog :visible.sync="showAdd" title="编辑配置" @close="cancelEdit">
      <el-form ref="editform" :model="editform" :rules="editformRules" class="editform" label-width="120px">
        ...
        <el-form-item label="数值范围" v-if="editform.field_type === 2" prop="range">
          <el-row class="rangRow">
            <el-col :span="11">
              <el-input type="number" v-model="editform.range.start"></el-input>
            </el-col>
            <el-col :span="2" style="text-align: center"> - </el-col>
            <el-col :span="11">
              <el-input type="number" v-model="editform.range.end"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item label="选项内容" v-if="editform.field_type === 4 || editform.field_type === 5" class="select" prop="select">
          <el-input v-model="selectValue.label" placeholder="内容" type="text" maxlength="10" show-word-limit>
            <template slot="append">
              <el-button type="primary" @click="saveSelect" :disabled="!isSelectValue">确认</el-button>
            </template>
          </el-input>
          <!-- <div class="tip">最多添加10条选项，注意添加顺序</div> -->
          <div class="tags">
            <el-tag class="item" v-for="item in editform.radio_list" :key="item.key" closable @close="handleRmoveTag(item)">{{ item.label }}</el-tag>
          </div>
        </el-form-item>
        <el-form-item label="提示文案" prop="alert_required_message">
          <el-input type="text" maxlength="15" v-model="editform.alert_required_message" show-word-limit />
        </el-form-item>
        <el-form-item>
