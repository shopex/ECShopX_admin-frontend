    ...
    <div v-if="$route.path.indexOf('editor') === -1">
      ...
      >
        <template>
          ...
          <el-table :data="activityItemListsData" v-loading="ItemLoading" :height="wheight - 190">
...
export default {
  provide() {
    return {
      refresh: this.getFullDiscountLists
    }
  },
  components: {
    shopSelect
