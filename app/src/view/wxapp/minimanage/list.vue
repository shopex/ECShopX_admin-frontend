<template>
  <div>
        ...
        <el-table-column label="操作" width="170">
          <template slot-scope="scope">
            ...
            <el-button
              size="mini" type="text"
              v-else
              @click="bindWxapp(scope.row)">绑定</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <sideBar :visible.sync="show_sideBar" :title="'绑定小程序'" width="50">
      <div class="radio">
        绑定类型：
      ...
      <div class="content-center no-bind">
...
export default {
  ...
  data() {
    return {
      dataLists: [
        {name:"yykweishop",key_name:"yykweishop"},
      ],
      loading: false,
      pageLimit: 10,
      total_count: 0,
