<template>
  <div class="zyk_adapay_account">
    <el-form v-if="$route.path.indexOf('detail') === -1" :model="form" ref="ruleForm" class="demo-ruleForm" label-width="100px">
      <el-card class="box-card" shadow="never">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="交易流水号" prop='trade_id'>
              <el-input v-model="form.trade_id"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8" v-if="$store.getters.login_type!='distributor'">
            <el-form-item label="店铺名称" prop='distributor_name'>
              <el-input v-model="form.distributor_name"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="支付方式" prop='pay_type'>
              <el-select v-model="form.pay_type" style="width: 100%" >
                <el-option label="微信小程序支付" value="wx_lite"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易状态" prop='status'>
              <el-select v-model="form.status" style="width: 100%" >
                <el-option label="支付完成" value="SUCCESS"></el-option>
                <el-option label="部分退款" value="PARTIAL_REFUND"></el-option>
                <el-option label="全额退款" value="FULL_REFUND"></el-option>

              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="分账状态" prop='adapay_div_status'>
              <el-select v-model="form.adapay_div_status" style="width: 100%">
                <el-option label="未分账" value="NOTDIV"></el-option>
                <el-option label="已分账" value="DIVED"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20" class="group">
          <el-col :span="6" class="item" v-if="$store.getters.login_type!='distributor'">
          ...
          <el-col :span="6" class="item"  v-if="$store.getters.login_type == 'normal' ||$store.getters.login_type == 'admin'">
        ...
        <div class="tablelist">
          ...
          <el-table
              ...
              <el-table-column v-if="$store.getters.login_type=='distributor'"
                label="交易金额"
                >
                <template slot-scope="scope">
                  <span>{{scope.row.totalFee /100 | formatNumMoney}}</span>
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  ...
                  width="100">
                  <template slot-scope="scope">
                    <el-button @click="goDetail(scope.row.tradeId)" type="text" size="small">查看</el-button>
                  </template>
                </el-table-column>                
          </el-table>
