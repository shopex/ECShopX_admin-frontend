  ...
  <div class="section-white" style="padding-bottom:70px">
    ...
    <div class="section-header with-border flex">
      ...
      <el-button
        ...
        size="large"
        style='margin-left:10px;line-height: 1.5;color: #5e6d82;font-weight: 500;font-size:16px;color:#459ae9;'
        >备注</el-button
      >
    </div>
    <div class="section-body">
      <el-row>
        ...
        <el-col :span="20">{{ aftersalesInfo.aftersales_bn }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">订单号:</el-col>
        <el-col :span="20">{{ aftersalesInfo.order_id }}</el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="20">{{ aftersalesInfo.refund_point }}</el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="20">
          <span v-if="aftersalesInfo.aftersales_status == '0'">
            等待商家处理</span
          >
      ...
      <el-row>
        ...
        <el-col :span="20">
          ...
          <span v-else-if="aftersalesInfo.progress == '1'"
            >商家接受申请，等待消费者回寄</span
          >
          <span v-else-if="aftersalesInfo.progress == '2'"
            >消费者回寄，等待商家收货确认</span
          >
      ...
      <el-row v-if="aftersalesInfo.refuse_reason">
        ...
        <el-col :span="20">{{ aftersalesInfo.refuse_reason }}</el-col>
      </el-row>
    </div>
          ...
          <el-table :data="aftersalesInfo.detail" style="width: 100%">
            ...
            >
              <template slot-scope="scope">
                <span
                  ><img :src="scope.row.item_pic" :alt="scope.row.item_name"
                /></span>
              </template>
            </el-table-column>
    ...
    <div class="section-body">
      <el-row>
        ...
        <el-col :span="20">{{ aftersalesInfo.reason }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">问题描述:</el-col>
        <el-col :span="20">{{ aftersalesInfo.description }}</el-col>
      </el-row>
    ...
    <template v-if="refundInfo.refund_fee">
      ...
      <div class="section-body">
        <el-row>
          ...
          <el-col :span="20">{{ refundInfo.refund_fee }}</el-col>
        </el-row>
        <el-row>
        ...
        <el-row v-if="refundInfo.refunds_memo">
          ...
          <el-col :span="20">{{ refundInfo.refunds_memo }}</el-col>
        </el-row>
      </div>
    </template>
    ...
    <template v-if="aftersalesInfo.sendback_data">
      ...
      <div class="section-body">
        ...
        <el-row>
          ...
          <el-col :span="20">{{ aftersalesInfo.sendback_data.logi_no }}</el-col>
        </el-row>
      </div>
    </template>
      ...
      <template v-else-if="aftersalesInfo.aftersales_type == 'REFUND_GOODS' && aftersalesInfo.distributor_id=='0'|| aftersalesInfo.aftersales_type == 'REFUND_GOODS' &&  $store.getters.login_type=='distributor' ">
        ...
        <div class="section-body">
          <template>
            ...
            <template
              v-if="
                aftersalesInfo.aftersales_type != 'EXCHANGING_GOODS' &&
                check_refund == '1'
              "
            >
            ...
            <div class="section-footer with-border content-center">
              <el-button
                ...
                >确认</el-button
              >
              <el-button type="primary" @click="refundAction" v-else
                >确认</el-button
              >
            </div>
          </template>
    ...
    >
      <el-form ref="dataForm" :model="dataForm" label-width="100px">
        ...
        <el-form-item label="详细地址">
          <el-input v-model="aftersales_address" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="联系人">
          <el-input v-model="aftersales_contact" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="联系方式">
          <el-input v-model="aftersales_mobile" placeholder=""></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    refundAction() {
      ...
      if (
        this.refundData.check_refund == "1" && !this.refundData.refund_fee
      ) {
        this.$message.error("退款金额必填！");
        return false;
      }
    ...
    handleSelectAftersalesAddress() {
      const fd = this.relShop.list.find(
        (item) => item.address_id == this.aftersales_select
      );
      if (fd) {
    ...
    handleRegionChange: function (value) {
      ...
      if (
        ...
        this.searchRegion =
          this.form.regions[0] + this.form.regions[1] + this.form.regions[2];
      }
    },
    createAddress() {
      const queryData = {};
      ...
      createAftersalesAddress(queryData).then((response) => {
        if (response.data.data.status) {
          ...
          this.aftersales_contact = fd.contact;
          this.aftersales_mobile = fd.mobile;
          this.aftersales_address =
            fd.province + fd.city + fd.area + fd.address;
        } else {
          this.$message({
            message: "添加失败",
            type: "error",
