          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="商品状态" required>
                <el-select class="width-full" v-model="value.specData.approve_status" placeholder="请选择">
                  <el-option
            ...
            <el-col :span="8" v-if="!isPackageItems">
              <el-form-item label="库存">
                <el-input type="number" required min="0" v-model="value.specData.store" placeholder=""></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="商品货号">
                <el-input v-model="value.specData.item_bn" :maxlength="60" placeholder=""></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="重量">
                <el-input type="number" required min="0" v-model="value.specData.weight" placeholder=""><template slot="append">kg</template></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="体积">
                <el-input type="number" required min="0" v-model="value.specData.volume" placeholder=""><template slot="append">m³</template></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="销售价">
                <el-input type="number" required min="0" v-model="value.specData.price" placeholder=""><template slot="prepend">¥</template></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="成本价">
                <el-input type="number" required min="0" v-model="value.specData.cost_price" placeholder=""><template slot="prepend">¥</template></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="条形码">
                <el-input required min="0" v-model="value.specData.barcode" placeholder=""></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8" v-if="pointAccess == 'items'">
              <el-form-item label="获取积分">
                <el-input type="number" required min="0" v-model="value.specData.point_num" placeholder=""></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
      ...
      <template v-else>
        ...
        <div class="sub-block">
          <div class="sku-row" v-for="(item, index) in value.skus" :key='index'>
            ...
            <div class="sku-list">
              <el-checkbox-group class="clearfix" v-model="item.checked_sku" 
        ...
        <div class="sub-block">
          ...
          :highlight-current-row="false">
            ...
            <el-table-column label="库存"  v-if="!isPackageItems">
              <template slot-scope="scope">
            ...
            <el-table-column label="获取积分" v-if="pointAccess == 'items'">
              <template slot-scope="scope">
          ...
          style="width: 100%">
            ...
            <el-table-column label="库存"  v-if="!isPackageItems" :render-header="renderRequire">
              <template slot-scope="scope">
                <el-input type="number" required min="0" v-model="scope.row.store" size="mini" placeholder=""></el-input>
              </template>
            </el-table-column>
            ...
            <el-table-column label="条形码">
              <template slot-scope="scope">
                <el-input :maxlength="6000" v-model="scope.row.barcode" size="mini" placeholder=""></el-input>
              </template>
            </el-table-column>
            <el-table-column label="获取积分" v-if="pointAccess == 'items'">
              <template slot-scope="scope">
