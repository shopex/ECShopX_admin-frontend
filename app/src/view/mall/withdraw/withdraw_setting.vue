    ...
    <el-card class="box-card" shadow="never">
      ...
      <div class="content">
        ...
        >
          ...
          <div v-if="form.flag=='yes'" class="rules">
            <el-form-item label="提现规则" prop="type">
              <el-radio-group v-model="form.rules">
                <el-radio label="month" >每月提取时间</el-radio>
                <el-radio label="day">每日提取时间</el-radio>
                <el-radio label="filter">当可提现余额大于 X 元，可提现</el-radio>
              </el-radio-group>
            </el-form-item>
            ...
            <el-form-item v-if="form.rules=='filter'">
               <el-input placeholder="请输入"  v-model="input2" style="width:300px">
            ...
            <el-form-item label="提现金额"  prop="type">
                 <el-input  v-model="input2" style="width:400px">
                  <template slot="append">元</template>
                </el-input>
            </el-form-item>
            <el-form-item label='提现类型' prop='type'>
                <el-select v-model="form.region" placeholder="请选择活动区域" style="width:400px">
          ...
          <div v-else class="rules">
            <el-form-item label="子商户每日限定提现额度" label-width="200px" prop='draw_limit'>
               <el-input placeholder="请输入"  v-model="form.draw_limit" style="width:300px">
                  <template slot="append">元</template>
                </el-input>
            </el-form-item>
            <p class="tips">子商户可提现金额需大于或等于限制额度才可以进行提现，超出提大现限额的金额，禁用子商户后该项设置对其无作用</p>
          </div>
          <el-form-item style="text-align:center;margin-top:50px;margin-right:130px">
              ...
              <loading-btn ref="loadingBtn" size='medium' type='primary' text='确认' @clickHandle="confirm('ruleForm','loadingBtn')" />
            </el-form-item>
        </el-form>
      </div>
    </el-card>
